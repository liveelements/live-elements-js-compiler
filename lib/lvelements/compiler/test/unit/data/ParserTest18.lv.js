...
export class TodoList extends Ul {
    ...
    __initialize() {
        ...
        Element.addProperty(this, 'items', { notify: 'itemsChanged'})
        Element.addProperty(this, 'conditionalChildren', { notify: 'conditionalChildrenChanged'})
        Element.addEvent(this, 'remove', [['number', 'index']])
        Element.addEvent(this, 'markTodoDone', [['number', 'index']])
        this.items = []

...
export class X extends Element{
    ...
    __initialize(){
        Element.addProperty(this, 'dExpr', { notify: 'dExprChanged'})
        Element.addProperty(this, 'dBlk', { notify: 'dBlkChanged'})
        Element.addProperty(this, 'dBindExpr', { notify: 'dBindExprChanged'})
        Element.addProperty(this, 'dBindBlock', { notify: 'dBindBlockChanged'})
